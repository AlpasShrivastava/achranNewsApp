          ...
          <div className="row">
            <div className="col-md-12">
              ...
              <div className="homePageScrollDiv">
                <div className="row mb-2">
                  ...
                  <div className="col-md-8">
                    <span>
                      हद से ज्यादा जिम आपकी जान को खतरे में डाल सकता हैं :
                      कार्डियोलॉजिस्ट
                    </span>
                    <br />
              ...
              <div className="card_div ">
                ...
                <h5 className="rajniti_h5">राजनीति</h5>
                <p className="rajniti_text text-center">
                  <span className="rajniti_spl">राजनीति -</span> ममता की नवीन
                  पटनायक से मुलाकात, तीसरे मोर्चा को लेकर बनेगी बात
                </p>
                <center>
                  <img
                    src="https://acharan.in/Admin_panel/public/image/news_image/1679576169.jpg"
              ...
              <div className="row rajniti_below_div mt-4 mb-2">
                <div className="col-sm-4">
                  <img
                    src="https://acharan.in/Admin_panel/public/image/news_image/1679902139.jpg"
                    alt=""
                  />
                </div>
                <div className="col-sm-8">
                  <span>
                    सुषमा स्वराज की बेटी बांसुरी स्वराज ने की राजनीति में एंट्री
                  </span>
                </div>
              </div>
              <div className="row rajniti_below_div mt-4 mb-2">
